...
![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-22 at 9.46.54 AM.png>)

Correlation matrix

![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-20 at 3.21.23 PM.png>)

Example of the hist plot for numeric features

![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-22 at 9.43.50 AM.png>)
Example count plot for categories features

![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-20 at 3.23.47 PM.png>)
## Prediction Model
...
```
![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-20 at 3.17.34 PM.png>)

Plot the actual and predicted claim
![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-20 at 3.17.42 PM.png>)
Feature importances

![alt text](<../Kaggle Competition/Insurance_Claim_Prediction/img/Screenshot 2024-10-20 at 3.17.54 PM.png>)
